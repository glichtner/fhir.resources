...
class Schedule(domainresource.DomainResource):
    ...
    "details to these referenced resource(s)."
		...
		enum_reference_types=["Patient", "Practitioner", "PractitionerRole", "CareTeam", "RelatedPerson", "Device", "HealthcareService", "Location"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "active", "serviceCategory", "serviceType", "specialty", "name", "actor", "planningHorizon", "comment"]
