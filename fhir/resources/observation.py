...
class Observation(domainresource.DomainResource):
    ...
    " fetal measurement based on an ultrasound image."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["DocumentReference", "ImagingStudy", "ImagingSelection", "QuestionnaireResponse", "Observation", "MolecularSequence", "GenomicStudy"],
	)
    ...
    "step.  For example,  an observation as part of a procedure."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["MedicationAdministration", "MedicationDispense", "MedicationUsage", "Procedure", "Immunization", "ImagingStudy", "GenomicStudy"],
	)
...
class ObservationComponent(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "valueQuantity", "valueCodeableConcept", "valueString", "valueBoolean", "valueInteger", "valueRange", "valueRatio", "valueSampledData", "valueTime", "valueDateTime", "valuePeriod", "valueAttachment", "dataAbsentReason", "interpretation", "referenceRange"]
...
class ObservationReferenceRange(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "low", "high", "normalValue", "type", "appliesTo", "age", "text"]
