...
class Immunization(domainresource.DomainResource):
    ...
    programEligibility: typing.List[fhirtypes.ImmunizationProgramEligibilityType] = Field(
		None,
...
class ImmunizationProtocolApplied(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "series", "authority", "targetDisease", "doseNumber", "seriesDoses"]
...
class ImmunizationReaction(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "date", "manifestation", "reported"]
