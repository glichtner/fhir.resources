...
class RequestOrchestration(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "instantiatesCanonical", "instantiatesUri", "basedOn", "replaces", "groupIdentifier", "status", "intent", "priority", "code", "subject", "encounter", "authoredOn", "author", "reason", "goal", "note", "action"]
...
class RequestOrchestrationAction(backboneelement.BackboneElement):
    ...
    dynamicValue: typing.List[fhirtypes.RequestOrchestrationActionDynamicValueType] = Field(
		None,
		alias="dynamicValue",
    ...
    participant: typing.List[fhirtypes.RequestOrchestrationActionParticipantType] = Field(
		None,
		alias="participant",
    ...
    relatedAction: typing.List[fhirtypes.RequestOrchestrationActionRelatedActionType] = Field(
		None,
		alias="relatedAction",
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "linkId", "prefix", "title", "description", "textEquivalent", "priority", "code", "documentation", "goal", "condition", "input", "output", "relatedAction", "timingDateTime", "timingAge", "timingPeriod", "timingDuration", "timingRange", "timingTiming", "location", "participant", "type", "groupingBehavior", "selectionBehavior", "requiredBehavior", "precheckBehavior", "cardinalityBehavior", "resource", "definitionCanonical", "definitionUri", "transform", "dynamicValue", "action"]
...
class RequestOrchestrationActionInput(backboneelement.BackboneElement):
    ...
    relatedData__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_relatedData",
        title="Extension field for ``relatedData``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "title", "requirement", "relatedData"]
...
class RequestOrchestrationActionParticipant(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "typeCanonical", "typeReference", "role", "function", "actorCanonical", "actorReference"]
