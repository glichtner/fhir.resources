...
class Invoice(domainresource.DomainResource):
    ...
    periodDate__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_periodDate",
        title="Extension field for ``periodDate``."
    )
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "cancelledReason", "type", "subject", "recipient", "date", "creation", "periodDate", "periodPeriod", "participant", "issuer", "account", "lineItem", "totalPriceComponent", "totalNet", "totalGross", "paymentTerms", "note"]
...
class InvoiceLineItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "sequence", "servicedDate", "servicedPeriod", "chargeItemReference", "chargeItemCodeableConcept", "priceComponent"]
