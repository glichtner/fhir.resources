...
class SubstanceNucleicAcid(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "sequenceType", "numberOfSubunits", "areaOfHybridisation", "oligoNucleotideType", "subunit"]
...
class SubstanceNucleicAcidSubunit(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "subunit", "sequence", "length", "sequenceAttachment", "fivePrime", "threePrime", "linkage", "sugar"]
...
class SubstanceNucleicAcidSubunitLinkage(backboneelement.BackboneElement):
    ...
    residueSite__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_residueSite",
        title="Extension field for ``residueSite``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "connectivity", "identifier", "name", "residueSite"]
...
class SubstanceNucleicAcidSubunitSugar(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "identifier", "name", "residueSite"]
