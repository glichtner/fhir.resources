...
class PaymentReconciliation(domainresource.DomainResource):
    ...
    cardBrand__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_cardBrand",
        title="Extension field for ``cardBrand``."
    )
    ...
    paymentIssuer: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Organization", "Patient", "Person", "RelatedPerson"],
	)
    ...
    processor__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_processor",
        title="Extension field for ``processor``."
    )
    ...
    type: fhirtypes.CodeableConceptType = Field(
		...
		description=(
    "Code to indicate the nature of the payment such as payment, "
    "adjustment."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "type", "status", "kind", "period", "created", "enterer", "issuerType", "paymentIssuer", "request", "requestor", "outcome", "disposition", "date", "location", "method", "cardBrand", "accountNumber", "expirationDate", "processor", "referenceNumber", "authorization", "tenderedAmount", "returnedAmount", "amount", "paymentIdentifier", "allocation", "formCode", "processNote"]
...
class PaymentReconciliationAllocation(backboneelement.BackboneElement):
    ...
    target: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Claim", "Account", "Invoice", "ChargeItem", "Encounter", "Contract"],
	)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "identifier", "predecessor", "target", "targetItemString", "targetItemIdentifier", "targetItemPositiveInt", "encounter", "account", "type", "submitter", "response", "date", "responsible", "payee", "amount"]
