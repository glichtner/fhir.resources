...
class MedicationDispense(domainresource.DomainResource):
    ...
    partOf: typing.List[fhirtypes.ReferenceType] = Field(
		...
		description=(
    "The procedure or medication administration that triggered the "
    "dispense."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "basedOn", "partOf", "status", "notPerformedReason", "statusChanged", "category", "medication", "subject", "encounter", "supportingInformation", "performer", "location", "authorizingPrescription", "type", "quantity", "daysSupply", "recorded", "whenPrepared", "whenHandedOver", "destination", "receiver", "note", "renderedDosageInstruction", "dosageInstruction", "substitution", "eventHistory"]
