...
class SpecimenDefinitionTypeTested(backboneelement.BackboneElement):
    ...
    singleUse__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_singleUse",
        title="Extension field for ``singleUse``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "isDerived", "type", "preference", "container", "requirement", "retentionTime", "singleUse", "rejectionCriterion", "handling", "testingDestination"]
