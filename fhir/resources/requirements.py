...
class Requirements(domainresource.DomainResource):
    ...
    actor: typing.List[fhirtypes.Canonical] = Field(
		None,
		alias="actor",
    ...
    actor__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_actor",
...
class RequirementsStatement(backboneelement.BackboneElement):
    ...
    conformance__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_conformance",
    ...
    satisfiedBy: typing.List[fhirtypes.Url] = Field(
		None,
		alias="satisfiedBy",
    ...
    satisfiedBy__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_satisfiedBy",
