...
class Organization(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "active", "type", "name", "alias", "description", "contact", "partOf", "endpoint", "qualification"]
