...
class DeviceUsage(domainresource.DomainResource):
    ...
    " another resource whose existence justifies this DeviceUsage."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Condition", "Observation", "DiagnosticReport", "DocumentReference", "Procedure"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "basedOn", "status", "category", "patient", "derivedFrom", "context", "timingTiming", "timingPeriod", "timingDateTime", "dateAsserted", "usageStatus", "usageReason", "adherence", "informationSource", "device", "reason", "bodySite", "note"]
