...
class StructureMapGroupRuleSource(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "context", "min", "max", "type", "defaultValue", "element", "listMode", "variable", "condition", "check", "logMessage"]
...
class StructureMapGroupRuleTarget(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "context", "element", "variable", "listMode", "listRuleId", "transform", "parameter"]
...
class StructureMapGroupRuleTargetParameter(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "valueId", "valueString", "valueBoolean", "valueInteger", "valueDecimal", "valueDate", "valueTime", "valueDateTime"]
