...
class Procedure(domainresource.DomainResource):
    ...
    "procedure."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Device", "Practitioner", "Organization", "Location"],
	)
    ...
    "of the procedure."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Device", "Medication", "Substance", "BiologicallyDerivedProduct"],
	)
    @classmethod
...
class ProcedurePerformer(backboneelement.BackboneElement):
    ...
    actor: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "Patient", "RelatedPerson", "Device", "CareTeam", "HealthcareService"],
	)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "function", "actor", "onBehalfOf", "period"]
