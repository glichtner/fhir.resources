...
class ArtifactAssessment(domainresource.DomainResource):
    ...
    artifactUri__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_artifactUri",
        title="Extension field for ``artifactUri``."
    )
    ...
    "change request."
		...
		enum_values=["unresolved", "not-persuasive", "persuasive", "persuasive-with-modification", "not-persuasive-with-modification"],
	)
...
class ArtifactAssessmentContent(backboneelement.BackboneElement):
    ...
    author: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Practitioner", "PractitionerRole", "Organization", "Device"],
	)
    ...
    informationType: fhirtypes.Code = Field(
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["comment", "classifier", "rating", "container", "response", "change-request"],
	)
    ...
    path: typing.List[fhirtypes.Uri] = Field(
		None,
		alias="path",
    ...
    path__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_path",
