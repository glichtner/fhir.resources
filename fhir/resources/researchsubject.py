...
class ResearchSubject(domainresource.DomainResource):
    ...
    subject: fhirtypes.ReferenceType = Field(
		...
		description=(
    "The record of the person, animal or other entity involved in the "
    "study."
    ),
        # if property is element of this resource.
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Specimen", "Device", "Medication", "Substance", "BiologicallyDerivedProduct"],
	)
    @classmethod
...
class ResearchSubjectProgress(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "subjectState", "milestone", "reason", "startDate", "endDate"]
