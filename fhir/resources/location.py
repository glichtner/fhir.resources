...
class Location(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "operationalStatus", "name", "alias", "description", "mode", "type", "contact", "address", "form", "position", "managingOrganization", "partOf", "characteristic", "hoursOfOperation", "virtualService", "endpoint"]
