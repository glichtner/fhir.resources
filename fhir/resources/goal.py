...
class Goal(domainresource.DomainResource):
    ...
    continuous__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_continuous",
        title="Extension field for ``continuous``."
    )
    ...
    source: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Practitioner", "PractitionerRole", "RelatedPerson", "CareTeam"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "lifecycleStatus", "achievementStatus", "category", "continuous", "priority", "description", "subject", "startDate", "startCodeableConcept", "target", "statusDate", "statusReason", "source", "addresses", "note", "outcome"]
