...
class Permission(domainresource.DomainResource):
    ...
    asserter: fhirtypes.ReferenceType = Field(
		...
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "CareTeam", "Patient", "RelatedPerson", "HealthcareService"],
	)
    ...
    "of rules."
		...
		enum_values=["deny-overrides", "permit-overrides", "ordered-deny-overrides", "ordered-permit-overrides", "deny-unless-permit", "permit-unless-deny"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "status", "asserter", "date", "validity", "justification", "combining", "rule"]
...
class PermissionRule(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "data", "activity", "limit"]
...
class PermissionRuleData(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "resource", "security", "period", "expression"]
