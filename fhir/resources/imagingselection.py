...
class ImagingSelection(domainresource.DomainResource):
    ...
    seriesUid__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_seriesUid",
        title="Extension field for ``seriesUid``."
    )
    ...
    studyUid__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_studyUid",
        title="Extension field for ``studyUid``."
    )
    ...
    "whose or what record the imaging selection is placed."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Device", "Location", "Organization", "Procedure", "Practitioner", "Medication", "Substance", "Specimen"],
	)
    @classmethod
...
class ImagingSelectionInstance(backboneelement.BackboneElement):
    ...
    subset__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_subset",
        title="Extension field for ``subset``."
    )
...
class ImagingSelectionPerformer(backboneelement.BackboneElement):
    ...
    actor: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Device", "Organization", "CareTeam", "Patient", "RelatedPerson", "HealthcareService"],
	)
