...
class Provenance(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "target", "occurredPeriod", "occurredDateTime", "recorded", "policy", "location", "authorization", "activity", "basedOn", "patient", "encounter", "agent", "entity", "signature"]
...
class ProvenanceAgent(backboneelement.BackboneElement):
    ...
    "by the agent.who element."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "CareTeam", "Patient"],
	)
