...
class Consent(domainresource.DomainResource):
    ...
    controller: typing.List[fhirtypes.ReferenceType] = Field(
		...
		enum_reference_types=["HealthcareService", "Organization", "Patient", "Practitioner"],
	)
    ...
    decision__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_decision",
        title="Extension field for ``decision``."
    )
    ...
    "enforcement of prohibitions."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["CareTeam", "HealthcareService", "Organization", "Patient", "Practitioner", "RelatedPerson", "PractitionerRole"],
	)
    ...
    status: fhirtypes.Code = Field(
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["draft", "active", "inactive", "not-done", "entered-in-error", "unknown"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "category", "subject", "date", "period", "grantor", "grantee", "manager", "controller", "sourceAttachment", "sourceReference", "regulatoryBasis", "policyBasis", "policyText", "verification", "decision", "provision"]
...
class ConsentProvision(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "period", "actor", "action", "securityLabel", "purpose", "documentType", "resourceType", "code", "dataPeriod", "data", "expression", "provision"]
...
class ConsentVerification(backboneelement.BackboneElement):
    ...
    verificationDate__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "verified", "verificationType", "verifiedBy", "verifiedWith", "verificationDate"]
