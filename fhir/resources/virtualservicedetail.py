...
class VirtualServiceDetail(datatype.DataType):
    ...
    additionalInfo: typing.List[fhirtypes.Url] = Field(
		None,
    ...
    additionalInfo__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "channelType", "addressUrl", "addressString", "addressContactPoint", "addressExtendedContactDetail", "additionalInfo", "maxParticipants", "sessionKey"]
