...
class ClaimResponse(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "type", "subType", "use", "patient", "created", "insurer", "requestor", "request", "outcome", "decision", "disposition", "preAuthRef", "preAuthPeriod", "payeeType", "encounter", "diagnosisRelatedGroup", "item", "addItem", "adjudication", "total", "payment", "fundsReserve", "formCode", "form", "processNote", "communicationRequest", "insurance", "error"]
...
class ClaimResponseAddItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "itemSequence", "detailSequence", "subdetailSequence", "provider", "revenue", "productOrService", "productOrServiceEnd", "modifier", "programCode", "servicedDate", "servicedPeriod", "locationCodeableConcept", "locationAddress", "locationReference", "quantity", "unitPrice", "factor", "tax", "net", "bodySite", "noteNumber", "decision", "adjudication", "detail"]
...
class ClaimResponseAddItemDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "revenue", "productOrService", "productOrServiceEnd", "modifier", "quantity", "unitPrice", "factor", "tax", "net", "noteNumber", "decision", "adjudication", "subDetail"]
...
class ClaimResponseAddItemDetailSubDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "revenue", "productOrService", "productOrServiceEnd", "modifier", "quantity", "unitPrice", "factor", "tax", "net", "noteNumber", "decision", "adjudication"]
...
class ClaimResponseItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "itemSequence", "noteNumber", "decision", "adjudication", "detail"]
...
class ClaimResponseItemDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "detailSequence", "noteNumber", "decision", "adjudication", "subDetail"]
...
class ClaimResponseItemDetailSubDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "subDetailSequence", "noteNumber", "decision", "adjudication"]
