...
class ImplementationGuideDefinitionPage(backboneelement.BackboneElement):
    ...
    sourceUrl__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_sourceUrl",
        title="Extension field for ``sourceUrl``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "sourceUrl", "sourceString", "sourceMarkdown", "name", "title", "generation", "page"]
...
class ImplementationGuideDefinitionResource(backboneelement.BackboneElement):
    ...
    isExample__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_isExample",
        title="Extension field for ``isExample``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "reference", "fhirVersion", "name", "description", "isExample", "profile", "groupingId"]
...
class ImplementationGuideDependsOn(backboneelement.BackboneElement):
    ...
    reason: fhirtypes.Markdown = Field(
		...
		description=(
    "A description explaining the nature of the dependency on the listed "
    "IG."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "uri", "packageId", "version", "reason"]
...
class ImplementationGuideManifestResource(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "reference", "isExample", "profile", "relativePath"]
