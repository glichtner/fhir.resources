...
class ChargeItem(domainresource.DomainResource):
    ...
    service: typing.List[fhirtypes.CodeableReferenceType] = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["DiagnosticReport", "ImagingStudy", "Immunization", "MedicationAdministration", "MedicationDispense", "MedicationRequest", "Observation", "Procedure", "ServiceRequest", "SupplyDelivery"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "definitionUri", "definitionCanonical", "status", "partOf", "code", "subject", "encounter", "occurrenceDateTime", "occurrencePeriod", "occurrenceTiming", "performer", "performingOrganization", "requestingOrganization", "costCenter", "quantity", "bodysite", "unitPriceComponent", "totalPriceComponent", "overrideReason", "enterer", "enteredDate", "reason", "service", "product", "account", "note", "supportingInformation"]
...
class ChargeItemPerformer(backboneelement.BackboneElement):
    ...
    "service."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "HealthcareService", "CareTeam", "Patient", "Device", "RelatedPerson"],
	)
