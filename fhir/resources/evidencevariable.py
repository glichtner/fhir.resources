...
class EvidenceVariableCharacteristicDefinitionByCombination(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("EvidenceVariableCharacteristicDefinitionByCombination", const=True)
    ...
    " AND."
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["all-of", "any-of", "at-least", "at-most", "statistical", "net-effect", "dataset"],
	)
    ...
    threshold__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_threshold",
        title="Extension field for ``threshold``."
    )
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "threshold", "characteristic"]
...
class EvidenceVariableCharacteristicDefinitionByTypeAndValue(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("EvidenceVariableCharacteristicDefinitionByTypeAndValue", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "method", "device", "valueCodeableConcept", "valueBoolean", "valueQuantity", "valueRange", "valueReference", "valueId", "offset"]
...
class EvidenceVariableCharacteristicTimeFromEvent(backboneelement.BackboneElement):
    ...
    eventId__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_eventId",
        title="Extension field for ``eventId``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "note", "eventCodeableConcept", "eventReference", "eventDateTime", "eventId", "quantity", "range"]
