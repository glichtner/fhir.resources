...
class EvidenceReportRelatesToTarget(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "url", "identifier", "display", "resource"]
...
class EvidenceReportSection(backboneelement.BackboneElement):
    ...
    " necessarily who typed it in."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Practitioner", "PractitionerRole", "RelatedPerson", "Device", "Group", "Organization"],
	)
