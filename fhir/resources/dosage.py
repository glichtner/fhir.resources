...
class Dosage(backbonetype.BackboneType):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "modifierExtension", "sequence", "text", "additionalInstruction", "patientInstruction", "timing", "asNeeded", "asNeededFor", "site", "route", "method", "doseAndRate", "maxDosePerPeriod", "maxDosePerAdministration", "maxDosePerLifetime"]
