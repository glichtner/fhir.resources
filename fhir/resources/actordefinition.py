...
class ActorDefinition(domainresource.DomainResource):
    ...
    date: fhirtypes.DateTime = Field(
		...
		description=(
    "The date  (and optionally time) when the actor definition was "
    "published. The date must change when the business version changes and "
    "it must change if the status code changes. In addition, it should "
    "change when the substantive content of the actor definition changes."
    ),
        # if property is element of this resource.
        element_property=True,
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "name", "title", "status", "experimental", "date", "publisher", "contact", "description", "useContext", "jurisdiction", "purpose", "copyright", "copyrightLabel", "type", "documentation", "reference", "capabilities", "derivedFrom"]
