...
class ConditionDefinition(domainresource.DomainResource):
    ...
    hasBodySite__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_hasBodySite",
        title="Extension field for ``hasBodySite``."
    )
    ...
    hasSeverity__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_hasSeverity",
        title="Extension field for ``hasSeverity``."
    )
    ...
    hasStage__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_hasStage",
        title="Extension field for ``hasStage``."
    )
    ...
    title: fhirtypes.String = Field(
		...
		description=(
    "A short, descriptive, user-friendly title for the condition "
    "definition."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "name", "title", "subtitle", "status", "experimental", "date", "publisher", "contact", "description", "useContext", "jurisdiction", "code", "severity", "bodySite", "stage", "hasSeverity", "hasBodySite", "hasStage", "definition", "observation", "medication", "precondition", "team", "questionnaire", "plan"]
...
class ConditionDefinitionPrecondition(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "code", "valueCodeableConcept", "valueQuantity"]
