...
class DocumentReference(domainresource.DomainResource):
    ...
    "document."
		...
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "Device", "Patient", "RelatedPerson", "CareTeam"],
	)
...
class DocumentReferenceContentProfile(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "valueCoding", "valueUri", "valueCanonical"]
