...
class BiologicallyDerivedProductDispense(domainresource.DomainResource):
    ...
    performer: typing.List[fhirtypes.BiologicallyDerivedProductDispensePerformerType] = Field(
		None,
		alias="performer",
    ...
    "returned | entered-in-error | unknown"
		...
		enum_values=["preparation", "in-progress", "allocated", "issued", "unfulfilled", "returned", "entered-in-error", "unknown"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "basedOn", "partOf", "status", "originRelationshipType", "product", "patient", "matchStatus", "performer", "location", "quantity", "preparedDate", "whenHandedOver", "destination", "note", "usageInstruction"]
