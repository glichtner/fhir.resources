...
class DataRequirement(datatype.DataType):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "extension", "type", "profile", "subjectCodeableConcept", "subjectReference", "mustSupport", "codeFilter", "dateFilter", "valueFilter", "limit", "sort"]
...
class DataRequirementValueFilter(element.Element):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "path", "searchParam", "comparator", "valueDateTime", "valuePeriod", "valueDuration"]
