...
class Subscription(domainresource.DomainResource):
    ...
    "authorized to disclose."
		...
		enum_reference_types=["CareTeam", "HealthcareService", "Organization", "RelatedPerson", "Patient", "Practitioner", "PractitionerRole"],
	)
    ...
    maxCount__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_maxCount",
        title="Extension field for ``maxCount``."
    )
    ...
    timeout__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_timeout",
        title="Extension field for ``timeout``."
    )
