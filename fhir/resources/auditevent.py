...
class AuditEvent(domainresource.DomainResource):
    ...
    "proposals/recommendations were acted upon."
		...
		enum_reference_types=["CarePlan", "DeviceRequest", "ImmunizationRecommendation", "MedicationRequest", "NutritionOrder", "ServiceRequest", "Task"],
	)
    ...
    "debugging from critical."
		...
		enum_values=["emergency", "alert", "critical", "error", "warning", "notice", "informational", "debug"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "category", "code", "action", "severity", "occurredPeriod", "occurredDateTime", "recorded", "outcome", "authorization", "basedOn", "patient", "encounter", "agent", "source", "entity"]
...
class AuditEventAgent(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "role", "who", "requestor", "location", "policy", "networkReference", "networkUri", "networkString", "authorization"]
...
class AuditEventEntity(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "what", "role", "securityLabel", "query", "detail", "agent"]
...
class AuditEventEntityDetail(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "valueQuantity", "valueCodeableConcept", "valueString", "valueBoolean", "valueInteger", "valueRange", "valueRatio", "valueTime", "valueDateTime", "valuePeriod", "valueBase64Binary"]
