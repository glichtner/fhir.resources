...
class CarePlan(domainresource.DomainResource):
    ...
    "is fulfilled in whole or in part by this care plan."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["CarePlan", "ServiceRequest", "RequestOrchestration", "NutritionOrder"],
	)
...
class CarePlanActivity(backboneelement.BackboneElement):
    ...
    "resource."
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Appointment", "CommunicationRequest", "DeviceRequest", "MedicationRequest", "NutritionOrder", "Task", "ServiceRequest", "VisionPrescription", "RequestOrchestration", "ImmunizationRecommendation", "SupplyRequest"],
	)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "performedActivity", "progress", "plannedActivityReference"]
