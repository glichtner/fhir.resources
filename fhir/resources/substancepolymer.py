...
class SubstancePolymer(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "class", "geometry", "copolymerConnectivity", "modification", "monomerSet", "repeat"]
...
class SubstancePolymerMonomerSet(backboneelement.BackboneElement):
    ...
    startingMaterial: typing.List[fhirtypes.SubstancePolymerMonomerSetStartingMaterialType] = Field(
		None,
...
class SubstancePolymerMonomerSetStartingMaterial(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "category", "isDefining", "amount"]
...
class SubstancePolymerRepeat(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "averageMolecularFormula", "repeatUnitAmountType", "repeatUnit"]
...
class SubstancePolymerRepeatRepeatUnit(backboneelement.BackboneElement):
    ...
    degreeOfPolymerisation: typing.List[fhirtypes.SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisationType] = Field(
		None,
    ...
    structuralRepresentation: typing.List[fhirtypes.SubstancePolymerRepeatRepeatUnitStructuralRepresentationType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "unit", "orientation", "amount", "degreeOfPolymerisation", "structuralRepresentation"]
...
class SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation(backboneelement.BackboneElement):
    ...
    polymerisation within a block can be described.
    """
    resource_type = Field("SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation", const=True)
    ...
    average__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_average",
        title="Extension field for ``average``."
    )
    ...
    high__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_high",
        title="Extension field for ``high``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "average", "low", "high"]
...
class SubstancePolymerRepeatRepeatUnitStructuralRepresentation(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("SubstancePolymerRepeatRepeatUnitStructuralRepresentation", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "representation", "format", "attachment"]
