...
class AdverseEvent(domainresource.DomainResource):
    ...
    contributingFactor: typing.List[fhirtypes.AdverseEventContributingFactorType] = Field(
		None,
    ...
    subject: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Practitioner", "RelatedPerson", "ResearchSubject"],
	)
...
class AdverseEventMitigatingAction(backboneelement.BackboneElement):
    ...
    " to reduce the extent of harm."
		...
		one_of_many_required=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Procedure", "DocumentReference", "MedicationAdministration", "MedicationRequest"],
	)
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
...
class AdverseEventParticipant(backboneelement.BackboneElement):
    ...
    actor: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Organization", "CareTeam", "Patient", "Device", "RelatedPerson", "ResearchSubject"],
	)
...
class AdverseEventPreventiveAction(backboneelement.BackboneElement):
    ...
    itemReference: fhirtypes.ReferenceType = Field(
		...
		one_of_many_required=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Immunization", "Procedure", "DocumentReference", "MedicationAdministration", "MedicationRequest"],
	)
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
...
class AdverseEventSuspectEntity(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "instanceCodeableConcept", "instanceReference", "causality"]
...
class AdverseEventSuspectEntityCausality(backboneelement.BackboneElement):
    ...
    author: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Practitioner", "PractitionerRole", "Patient", "RelatedPerson", "ResearchSubject"],
	)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "assessmentMethod", "entityRelatedness", "author"]
