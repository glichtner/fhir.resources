...
class ExampleScenario(domainresource.DomainResource):
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "versionAlgorithmString", "versionAlgorithmCoding", "name", "title", "status", "experimental", "date", "publisher", "contact", "description", "useContext", "jurisdiction", "purpose", "copyright", "copyrightLabel", "actor", "instance", "process"]
...
class ExampleScenarioActor(backboneelement.BackboneElement):
    ...
    title: fhirtypes.String = Field(
		...
		description=(
    "The human-readable name for the actor used when rendering the "
    "scenario."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "key", "type", "title", "description"]
...
class ExampleScenarioInstance(backboneelement.BackboneElement):
    ...
    structureProfileCanonical: fhirtypes.Canonical = Field(
		...
		description=(
    "Refers to a profile, template or other ruleset the instance adheres "
    "to."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "key", "structureType", "structureVersion", "structureProfileCanonical", "structureProfileUri", "title", "description", "content", "version", "containedInstance"]
...
class ExampleScenarioInstanceContainedInstance(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "instanceReference", "versionReference"]
...
class ExampleScenarioProcessStep(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "number", "process", "workflow", "operation", "alternative", "pause"]
...
class ExampleScenarioProcessStepOperation(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "title", "initiator", "receiver", "description", "initiatorActive", "receiverActive", "request", "response"]
