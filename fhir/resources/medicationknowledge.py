...
class MedicationKnowledge(domainresource.DomainResource):
    ...
    indicationGuideline: typing.List[fhirtypes.MedicationKnowledgeIndicationGuidelineType] = Field(
		None,
    ...
    "information of this resource was created"
		...
		description=(
    "Lists the jurisdictions that this medication knowledge was written "
    "for."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    storageGuideline: typing.List[fhirtypes.MedicationKnowledgeStorageGuidelineType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "code", "status", "author", "intendedJurisdiction", "name", "relatedMedicationKnowledge", "associatedMedication", "productType", "monograph", "preparationInstruction", "cost", "monitoringProgram", "indicationGuideline", "medicineClassification", "packaging", "clinicalUseIssue", "storageGuideline", "regulatory", "definitional"]
...
class MedicationKnowledgeCost(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "effectiveDate", "type", "source", "costMoney", "costCodeableConcept"]
...
class MedicationKnowledgeDefinitional(backboneelement.BackboneElement):
    ...
    drugCharacteristic: typing.List[fhirtypes.MedicationKnowledgeDefinitionalDrugCharacteristicType] = Field(
		None,
    ...
    ingredient: typing.List[fhirtypes.MedicationKnowledgeDefinitionalIngredientType] = Field(
		None,
		alias="ingredient",
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "definition", "doseForm", "intendedRoute", "ingredient", "drugCharacteristic"]
...
class MedicationKnowledgeDefinitionalDrugCharacteristic(backboneelement.BackboneElement):
    ...
    imprints, etc.
    """
    resource_type = Field("MedicationKnowledgeDefinitionalDrugCharacteristic", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "valueCodeableConcept", "valueString", "valueQuantity", "valueBase64Binary", "valueAttachment"]
...
class MedicationKnowledgeDefinitionalIngredient(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "item", "type", "strengthRatio", "strengthCodeableConcept", "strengthQuantity"]
...
class MedicationKnowledgeIndicationGuideline(backboneelement.BackboneElement):
    ...
    dosingGuideline: typing.List[fhirtypes.MedicationKnowledgeIndicationGuidelineDosingGuidelineType] = Field(
		None,
...
class MedicationKnowledgeIndicationGuidelineDosingGuideline(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("MedicationKnowledgeIndicationGuidelineDosingGuideline", const=True)
    ...
    dosage: typing.List[fhirtypes.MedicationKnowledgeIndicationGuidelineDosingGuidelineDosageType] = Field(
		None,
		alias="dosage",
    ...
    patientCharacteristic: typing.List[fhirtypes.MedicationKnowledgeIndicationGuidelineDosingGuidelinePatientCharacteristicType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "treatmentIntent", "dosage", "administrationTreatment", "patientCharacteristic"]
...
class MedicationKnowledgeIndicationGuidelineDosingGuidelineDosage(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("MedicationKnowledgeIndicationGuidelineDosingGuidelineDosage", const=True)
...
class MedicationKnowledgeIndicationGuidelineDosingGuidelinePatientCharacteristic(backboneelement.BackboneElement):
    ...
    guidelines (for example, height, weight, gender, etc.).
    """
    resource_type = Field("MedicationKnowledgeIndicationGuidelineDosingGuidelinePatientCharacteristic", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "valueCodeableConcept", "valueQuantity", "valueRange"]
...
class MedicationKnowledgeMedicineClassification(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "sourceString", "sourceUri", "classification"]
...
class MedicationKnowledgeStorageGuideline(backboneelement.BackboneElement):
    ...
    environmentalSetting: typing.List[fhirtypes.MedicationKnowledgeStorageGuidelineEnvironmentalSettingType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "reference", "note", "stabilityDuration", "environmentalSetting"]
...
class MedicationKnowledgeStorageGuidelineEnvironmentalSetting(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("MedicationKnowledgeStorageGuidelineEnvironmentalSetting", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "valueQuantity", "valueRange", "valueCodeableConcept"]
