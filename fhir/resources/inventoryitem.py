...
class InventoryItem(domainresource.DomainResource):
    ...
    productReference: fhirtypes.ReferenceType = Field(
		...
		enum_reference_types=["Medication", "Device", "NutritionProduct", "BiologicallyDerivedProduct"],
	)
	
    responsibleOrganization: typing.List[fhirtypes.InventoryItemResponsibleOrganizationType] = Field(
		None,
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "status", "category", "code", "name", "responsibleOrganization", "description", "inventoryStatus", "baseUnit", "netContent", "association", "characteristic", "instance", "productReference"]
...
class InventoryItemAssociation(backboneelement.BackboneElement):
    ...
    relatedItem: fhirtypes.ReferenceType = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["InventoryItem", "Medication", "MedicationKnowledge", "Device", "DeviceDefinition", "NutritionProduct", "BiologicallyDerivedProduct"],
	)
    @classmethod
    def elements_sequence(cls):
        """returning all elements names from
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "associationType", "relatedItem", "quantity"]
...
class InventoryItemCharacteristic(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "characteristicType", "valueString", "valueInteger", "valueDecimal", "valueBoolean", "valueUrl", "valueDateTime", "valueQuantity", "valueRange", "valueRatio", "valueAnnotation", "valueAddress", "valueDuration", "valueCodeableConcept"]
...
class InventoryItemInstance(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "identifier", "lotNumber", "expiry", "subject", "location"]
