...
class ValueSetCompose(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "lockedDate", "inactive", "include", "exclude", "property"]
...
class ValueSetComposeInclude(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "system", "version", "concept", "filter", "valueSet", "copyright"]
...
class ValueSetComposeIncludeConceptDesignation(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "language", "use", "additionalUse", "value"]
...
class ValueSetComposeIncludeFilter(backboneelement.BackboneElement):
    ...
    "generalizes | child-of | descendent-leaf | exists"
        ...
        # note: Enum values can be used in validation,
        # but use in your own responsibilities, read official FHIR documentation.
		enum_values=["=", "is-a", "descendent-of", "is-not-a", "regex", "in", "not-in", "generalizes", "child-of", "descendent-leaf", "exists"],
	)
...
class ValueSetExpansion(backboneelement.BackboneElement):
    ...
    next__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_next",
        title="Extension field for ``next``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "identifier", "next", "timestamp", "total", "offset", "parameter", "property", "contains"]
...
class ValueSetExpansionContains(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "system", "abstract", "inactive", "version", "code", "display", "designation", "property", "contains"]
...
class ValueSetExpansionContainsProperty(backboneelement.BackboneElement):
    ...
    subProperty: typing.List[fhirtypes.ValueSetExpansionContainsPropertySubPropertyType] = Field(
		None,
		alias="subProperty",
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "code", "valueCode", "valueCoding", "valueString", "valueInteger", "valueBoolean", "valueDateTime", "valueDecimal", "subProperty"]
...
class ValueSetScope(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "inclusionCriteria", "exclusionCriteria"]
