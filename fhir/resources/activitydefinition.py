...
class ActivityDefinition(domainresource.DomainResource):
    ...
    observationRequirement: typing.List[fhirtypes.Canonical] = Field(
		None,
    ...
    observationRequirement__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_observationRequirement",
        title="Extension field for ``observationRequirement``."
    )
	
    observationResultRequirement: typing.List[fhirtypes.Canonical] = Field(
		None,
    ...
    observationResultRequirement__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    specimenRequirement: typing.List[fhirtypes.Canonical] = Field(
		None,
    ...
    specimenRequirement__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
