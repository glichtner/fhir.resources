...
class QuestionnaireItem(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "linkId", "definition", "code", "prefix", "text", "type", "enableWhen", "enableBehavior", "disabledDisplay", "required", "repeats", "readOnly", "maxLength", "answerConstraint", "answerValueSet", "answerOption", "initial", "item"]
...
class QuestionnaireItemEnableWhen(backboneelement.BackboneElement):
    ...
    question: fhirtypes.String = Field(
		...
		alias="question",
		title=(
    "The linkId of question that determines whether item is "
    "enabled/disabled"
    ),
		description=(
