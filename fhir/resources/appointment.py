...
class Appointment(domainresource.DomainResource):
    ...
    originatingAppointment: fhirtypes.ReferenceType = Field(
		...
		description=(
    "The originating appointment in a recurring set of related "
    "appointments."
    ),
        # if property is element of this resource.
        element_property=True,
    ...
    recurrenceTemplate: typing.List[fhirtypes.AppointmentRecurrenceTemplateType] = Field(
		None,
		alias="recurrenceTemplate",
		title=(
    "Details of the recurrence pattern/template used to generate "
    "occurrences"
    ),
		description=(
...
class AppointmentParticipant(backboneelement.BackboneElement):
    ...
    "appointment"
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Practitioner", "PractitionerRole", "CareTeam", "RelatedPerson", "Device", "HealthcareService", "Location"],
	)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "period", "actor", "required", "status"]
...
class AppointmentRecurrenceTemplate(backboneelement.BackboneElement):
    ...
    excludingDate: typing.List[fhirtypes.Date] = Field(
		None,
		alias="excludingDate",
    ...
    excludingDate__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_excludingDate",
        title="Extension field for ``excludingDate``."
    )
	
    excludingRecurrenceId: typing.List[fhirtypes.PositiveInt] = Field(
		None,
    ...
    excludingRecurrenceId__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    occurrenceDate: typing.List[fhirtypes.Date] = Field(
		None,
    ...
    occurrenceDate__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "timezone", "recurrenceType", "lastOccurrenceDate", "occurrenceCount", "occurrenceDate", "weeklyTemplate", "monthlyTemplate", "yearlyTemplate", "excludingDate", "excludingRecurrenceId"]
...
class AppointmentRecurrenceTemplateMonthlyTemplate(backboneelement.BackboneElement):
    ...
    dayOfMonth__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_dayOfMonth",
        title="Extension field for ``dayOfMonth``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "dayOfMonth", "nthWeekOfMonth", "dayOfWeek", "monthInterval"]
    ...
    def validate_required_primitive_elements_4774(
        ...
        """
        required_fields = [
			("monthInterval", "monthInterval__ext")]
        _missing = object()
...
class AppointmentRecurrenceTemplateWeeklyTemplate(backboneelement.BackboneElement):
    ...
    friday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_friday",
        title="Extension field for ``friday``."
    )
    ...
    monday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_monday",
        title="Extension field for ``monday``."
    )
    ...
    saturday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_saturday",
        title="Extension field for ``saturday``."
    )
    ...
    sunday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_sunday",
        title="Extension field for ``sunday``."
    )
    ...
    thursday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_thursday",
        title="Extension field for ``thursday``."
    )
    ...
    tuesday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_tuesday",
        title="Extension field for ``tuesday``."
    )
    ...
    wednesday__ext: fhirtypes.FHIRPrimitiveExtensionType = Field(
        None,
        alias="_wednesday",
        title="Extension field for ``wednesday``."
    )
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "monday", "tuesday", "wednesday", "thursday", "friday", "saturday", "sunday", "weekInterval"]
...
class AppointmentRecurrenceTemplateYearlyTemplate(backboneelement.BackboneElement):
    ...
    def validate_required_primitive_elements_4657(
        ...
        """
        required_fields = [
			("yearInterval", "yearInterval__ext")]
        _missing = object()
