...
MODEL_CLASSES = {
     ...
     "DeviceDefinitionUdiDeviceIdentifierMarketDistribution": (None, ".devicedefinition"),
     ...
     "EvidenceVariableCharacteristicDefinitionByCombination": (None, ".evidencevariable"),
     
     "EvidenceVariableCharacteristicDefinitionByTypeAndValue": (None, ".evidencevariable"),
     ...
     "ManufacturedItemDefinitionComponentConstituent": (None, ".manufactureditemdefinition"),
     ...
     "MedicationKnowledgeIndicationGuidelineDosingGuideline": (None, ".medicationknowledge"),
     
     "MedicationKnowledgeIndicationGuidelineDosingGuidelineDosage": (None, ".medicationknowledge"),
     
     "MedicationKnowledgeIndicationGuidelineDosingGuidelinePatientCharacteristic": (None, ".medicationknowledge"),
     ...
     "MedicationKnowledgeStorageGuidelineEnvironmentalSetting": (None, ".medicationknowledge"),
     ...
     "PackagedProductDefinitionPackagingContainedItem": (None, ".packagedproductdefinition"),
     ...
     "SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation": (None, ".substancepolymer"),
     
     "SubstancePolymerRepeatRepeatUnitStructuralRepresentation": (None, ".substancepolymer"),
     ...
     "SubstanceReferenceInformationGeneElement": (None, ".substancereferenceinformation"),
...
def adverseeventcontributingfactor_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEventContributingFactor", v)

def adverseeventmitigatingaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEventMitigatingAction", v)

def adverseeventparticipant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEventParticipant", v)

def adverseeventpreventiveaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AdverseEventPreventiveAction", v)

def adverseeventsupportinginfo_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def allergyintoleranceparticipant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def appointmentrecurrencetemplate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AppointmentRecurrenceTemplate", v)

def appointmentrecurrencetemplatemonthlytemplate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AppointmentRecurrenceTemplateMonthlyTemplate", v)

def appointmentrecurrencetemplateweeklytemplate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AppointmentRecurrenceTemplateWeeklyTemplate", v)

def appointmentrecurrencetemplateyearlytemplate_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def artifactassessmentcontent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def availabilityavailabletime_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("AvailabilityAvailableTime", v)

def availabilitynotavailabletime_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def claimresponseadditembodysite_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def conditiondefinitionmedication_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ConditionDefinitionMedication", v)

def conditiondefinitionobservation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ConditionDefinitionObservation", v)

def conditiondefinitionplan_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ConditionDefinitionPlan", v)

def conditiondefinitionprecondition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ConditionDefinitionPrecondition", v)

def conditiondefinitionquestionnaire_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def datarequirementvaluefilter_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitionchargeitem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitionguideline_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionGuideline", v)

def devicedefinitionhaspart_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitionpackaging_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionPackaging", v)

def devicedefinitionpackagingdistributor_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitionregulatoryidentifier_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedefinitionudideviceidentifiermarketdistribution_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("DeviceDefinitionUdiDeviceIdentifierMarketDistribution", v)

def devicedefinitionversion_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def devicedispenseperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def diagnosticreportsupportinginfo_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def documentreferenceattester_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def documentreferencecontentprofile_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencereportrelatestotarget_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def evidencevariablecharacteristicdefinitionbycombination_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceVariableCharacteristicDefinitionByCombination", v)

def evidencevariablecharacteristicdefinitionbytypeandvalue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("EvidenceVariableCharacteristicDefinitionByTypeAndValue", v)

def evidencevariablecharacteristictimefromevent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def explanationofbenefitadditembodysite_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def explanationofbenefititembodysite_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def genomicstudyanalysisdevice_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("GenomicStudyAnalysisDevice", v)

def genomicstudyanalysisinput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("GenomicStudyAnalysisInput", v)

def genomicstudyanalysisoutput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("GenomicStudyAnalysisOutput", v)

def genomicstudyanalysisperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def immunizationprogrameligibility_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def inventoryreportinventorylisting_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def manufactureditemdefinitioncomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ManufacturedItemDefinitionComponent", v)

def manufactureditemdefinitioncomponentconstituent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def medicationknowledgedefinitional_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeDefinitional", v)

def medicationknowledgedefinitionaldrugcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeDefinitionalDrugCharacteristic", v)

def medicationknowledgedefinitionalingredient_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeDefinitionalIngredient", v)

def medicationknowledgeindicationguideline_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeIndicationGuideline", v)

def medicationknowledgeindicationguidelinedosingguideline_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeIndicationGuidelineDosingGuideline", v)

def medicationknowledgeindicationguidelinedosingguidelinedosage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeIndicationGuidelineDosingGuidelineDosage", v)

def medicationknowledgeindicationguidelinedosingguidelinepatientcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeIndicationGuidelineDosingGuidelinePatientCharacteristic", v)
...
def medicationknowledgestorageguideline_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeStorageGuideline", v)

def medicationknowledgestorageguidelineenvironmentalsetting_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicationKnowledgeStorageGuidelineEnvironmentalSetting", v)
...
def medicinalproductdefinitionnamepart_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MedicinalProductDefinitionNamePart", v)

def medicinalproductdefinitionnameusage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def molecularsequencerelative_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceRelative", v)

def molecularsequencerelativeedit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("MolecularSequenceRelativeEdit", v)

def molecularsequencerelativestartingsequence_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionintakeconsumeditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("NutritionIntakeConsumedItem", v)

def nutritionintakeingredientlabel_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("NutritionIntakeIngredientLabel", v)

def nutritionintakeperformer_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionorderenteralformulaadditive_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionorderenteralformulaadministrationschedule_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionorderoraldietschedule_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionordersupplementschedule_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def nutritionproductcharacteristic_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def observationdefinitioncomponent_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ObservationDefinitionComponent", v)

def observationdefinitionqualifiedvalue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def organizationqualification_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def packagedproductdefinitionpackaging_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionPackaging", v)

def packagedproductdefinitionpackagingcontaineditem_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PackagedProductDefinitionPackagingContainedItem", v)

def packagedproductdefinitionpackagingproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def paymentreconciliationallocation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def permissionjustification_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def permissionruledataresource_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def plandefinitionactioninput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("PlanDefinitionActionInput", v)

def plandefinitionactionoutput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def plandefinitionactoroption_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def requestorchestrationaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationAction", v)

def requestorchestrationactioncondition_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationActionCondition", v)

def requestorchestrationactiondynamicvalue_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationActionDynamicValue", v)

def requestorchestrationactioninput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationActionInput", v)

def requestorchestrationactionoutput_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationActionOutput", v)

def requestorchestrationactionparticipant_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("RequestOrchestrationActionParticipant", v)

def requestorchestrationactionrelatedaction_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def researchstudyassociatedparty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ResearchStudyAssociatedParty", v)

def researchstudycomparisongroup_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def researchstudyoutcomemeasure_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ResearchStudyOutcomeMeasure", v)

def researchstudyprogressstatus_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def researchsubjectprogress_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def substancenucleicacidsubunit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceNucleicAcidSubunit", v)

def substancenucleicacidsubunitlinkage_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceNucleicAcidSubunitLinkage", v)

def substancenucleicacidsubunitsugar_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def substancepolymermonomerset_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstancePolymerMonomerSet", v)

def substancepolymermonomersetstartingmaterial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def substancepolymerrepeatrepeatunit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstancePolymerRepeatRepeatUnit", v)

def substancepolymerrepeatrepeatunitdegreeofpolymerisation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstancePolymerRepeatRepeatUnitDegreeOfPolymerisation", v)

def substancepolymerrepeatrepeatunitstructuralrepresentation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstancePolymerRepeatRepeatUnitStructuralRepresentation", v)
...
def substanceproteinsubunit_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceProteinSubunit", v)

def substancereferenceinformation_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceReferenceInformation", v)

def substancereferenceinformationgene_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceReferenceInformationGene", v)

def substancereferenceinformationgeneelement_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceReferenceInformationGeneElement", v)

def substancereferenceinformationtarget_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceReferenceInformationTarget", v)

def substancesourcematerial_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterial", v)

def substancesourcematerialfractiondescription_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterialFractionDescription", v)

def substancesourcematerialorganism_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterialOrganism", v)

def substancesourcematerialorganismauthor_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterialOrganismAuthor", v)

def substancesourcematerialorganismhybrid_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterialOrganismHybrid", v)

def substancesourcematerialorganismorganismgeneral_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("SubstanceSourceMaterialOrganismOrganismGeneral", v)

def substancesourcematerialpartdescription_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def valuesetexpansioncontainsproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):

	return fhir_model_validator("ValueSetExpansionContainsProperty", v)

def valuesetexpansioncontainspropertysubproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
...
def valuesetexpansionproperty_validator(v: Union[StrBytes, dict, Path, FHIRAbstractModel]):
