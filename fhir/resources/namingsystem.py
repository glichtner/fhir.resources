...
class NamingSystem(domainresource.DomainResource):
    ...
    " NamingSystem for use in some setting."
    ),
        # if property is element of this resource.
        element_property=True,
	)
    ...
    lastReviewDate: fhirtypes.Date = Field(
		...
		title="When the NamingSystem was last reviewed",
		description=(
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "url", "identifier", "version", "name", "title", "status", "kind", "experimental", "date", "publisher", "contact", "responsible", "type", "description", "useContext", "jurisdiction", "purpose", "copyright", "approvalDate", "lastReviewDate", "effectivePeriod", "topic", "author", "editor", "reviewer", "endorser", "relatedArtifact", "usage", "uniqueId"]
...
class NamingSystemUniqueId(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "value", "preferred", "comment", "period", "authoritative"]
