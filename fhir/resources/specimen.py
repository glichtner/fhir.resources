...
class Specimen(domainresource.DomainResource):
    ...
    "of a substance, a biologically-derived product, or a device"
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["Patient", "Group", "Device", "BiologicallyDerivedProduct", "Substance", "Location"],
	)
    ...
    def elements_sequence(cls):
        ...
        """
        return ["id", "meta", "implicitRules", "language", "text", "contained", "extension", "modifierExtension", "identifier", "accessionIdentifier", "status", "type", "subject", "receivedTime", "parent", "request", "combined", "role", "feature", "collection", "processing", "container", "condition", "note"]
...
class SpecimenCollection(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "collector", "collectedDateTime", "collectedPeriod", "duration", "quantity", "method", "device", "procedure", "bodySite", "fastingStatusCodeableConcept", "fastingStatusDuration"]
...
class SpecimenContainer(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "device", "location", "specimenQuantity"]
...
class SpecimenProcessing(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "description", "method", "additive", "timeDateTime", "timePeriod"]
