...
class OperationDefinitionParameter(backboneelement.BackboneElement):
    ...
    allowedType: typing.List[fhirtypes.Code] = Field(
		None,
		alias="allowedType",
    ...
    allowedType__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_allowedType",
        title="Extension field for ``allowedType``."
    )
    ...
    scope: typing.List[fhirtypes.Code] = Field(
		None,
		alias="scope",
    ...
    scope__ext: typing.List[typing.Union[fhirtypes.FHIRPrimitiveExtensionType, None]] = Field(
        None,
        alias="_scope",
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "name", "use", "scope", "min", "max", "documentation", "type", "allowedType", "targetProfile", "searchType", "binding", "referencedFrom", "part"]
