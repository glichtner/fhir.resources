...
class NutritionOrder(domainresource.DomainResource):
    ...
    performer: typing.List[fhirtypes.CodeableReferenceType] = Field(
        ...
        element_property=True,
        # note: Listed Resource Type(s) should be allowed as Reference.
		enum_reference_types=["CareTeam", "Practitioner", "PractitionerRole", "RelatedPerson", "Patient", "Organization"],
	)
...
class NutritionOrderEnteralFormula(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "baseFormulaType", "baseFormulaProductName", "deliveryDevice", "additive", "caloricDensity", "routeOfAdministration", "administration", "maxVolumeToDeliver", "administrationInstruction"]
...
class NutritionOrderEnteralFormulaAdditive(backboneelement.BackboneElement):
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "type", "productName", "quantity"]
...
class NutritionOrderEnteralFormulaAdministrationSchedule(backboneelement.BackboneElement):
    ...
    """
    resource_type = Field("NutritionOrderEnteralFormulaAdministrationSchedule", const=True)
    ...
    def elements_sequence(cls):
        ...
        with preserving original sequence order.
        """
        return ["id", "extension", "modifierExtension", "timing", "asNeeded", "asNeededFor"]
