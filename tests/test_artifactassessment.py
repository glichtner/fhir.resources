...
from fhir.resources import artifactassessment
...
def impl_artifactassessment_1(inst):
    ...
    "Brian S. Alper, Joanne Dehnbostel, Harold Lehmann, Kenneth "
    "Wilkins"
    )
    ...
    "Response-adaptive randomization led to imbalanced "
    "randomization."
    )
    ...
    assert inst.content[0].component[1].component[4].type.text == "Confounding difference"
    assert inst.content[0].component[1].type.text == "Confounding Covariate Bias"
    assert inst.content[0].component[2].author.display == (
    "Brian S. Alper, Joanne Dehnbostel, Harold Lehmann, Muhammad "
    "Afzal"
    )
    ...
    "Brian S. Alper; clarifying explanation reviewed by Janice "
    "Tufte"
    )
    ...
    "Lack of blinding may explain reported differences in the "
    "primary outcome."
    )
    assert inst.content[0].component[2].component[1].type.text == "Inadequate blinding of intervention deliverers"
    assert inst.content[0].component[2].component[2].author.display == "Surbhi Shah, Brian S. Alper"
    assert inst.content[0].component[2].component[2].classifier[0].text == "degree of concern unclear"
    ...
    assert inst.content[0].component[2].component[2].summary == "Crossover to other intervention in 20%"
    assert inst.content[0].component[2].component[2].type.text == "Deviation from study intervention protocol"
    ...
    assert inst.content[0].component[2].component[3].classifier[0].text == "limited concern"
    ...
    assert inst.content[0].component[2].component[3].type.text == "Nonadherence of implementation"
    ...
    "Brian S. Alper, Joanne Dehnbostel, Muhammad Afzal, Janice "
    "Tufte"
    )
    ...
    assert inst.content[0].component[5].component[1].type.text == "Bias related to selection of the analysis"
    ...
    assert inst.content[0].component[5].component[2].type.text == "Early trial termination"
...
def test_artifactassessment_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "artifactassessment-risk-of-bias-example.json"
    )
...
def impl_artifactassessment_2(inst):
    ...
    "serious concerns with risk of bias, inconsistency, and "
    "imprecision"
    )
...
def test_artifactassessment_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "artifactassessment-example-certainty-rating.json"
    )
    inst = artifactassessment.ArtifactAssessment.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
