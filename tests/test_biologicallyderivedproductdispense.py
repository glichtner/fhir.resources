...
from fhir.resources import biologicallyderivedproductdispense
...
def test_biologicallyderivedproductdispense_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "biologicallyderivedproductdispense-example.json"
    )
    ...
    inst2 = biologicallyderivedproductdispense.BiologicallyDerivedProductDispense(**data)
