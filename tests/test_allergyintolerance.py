...
def impl_allergyintolerance_3(inst):
    ...
    assert inst.reaction[0].manifestation[0].concept.coding[0].display == "Anaphylactic reaction"
    assert inst.reaction[0].manifestation[0].concept.coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.reaction[1].manifestation[0].concept.coding[0].system == "http://snomed.info/sct"
