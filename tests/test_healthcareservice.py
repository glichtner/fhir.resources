...
def impl_healthcareservice_1(inst):
    ...
    assert inst.availability[0].availableTime[1].availableEndTime == fhirtypes.Time.validate("05:30:00")
    assert inst.availability[0].availableTime[1].availableStartTime == fhirtypes.Time.validate("08:30:00")
    ...
    assert inst.availability[0].availableTime[2].availableEndTime == fhirtypes.Time.validate("04:30:00")
    assert inst.availability[0].availableTime[2].availableStartTime == fhirtypes.Time.validate("09:30:00")
    ...
    assert inst.availability[0].notAvailableTime[0].during.end == fhirtypes.DateTime.validate("2015-12-26")
    assert inst.availability[0].notAvailableTime[0].during.start == fhirtypes.DateTime.validate("2015-12-25")
    assert inst.availability[0].notAvailableTime[1].description == "New Years Day"
    assert inst.availability[0].notAvailableTime[1].during.end == fhirtypes.DateTime.validate("2016-01-01")
    assert inst.availability[0].notAvailableTime[1].during.start == fhirtypes.DateTime.validate("2016-01-01")
