...
def impl_subscription_1(inst):
    ...
    assert inst.filterBy[0].searchParamName == "patient"
    ...
    assert inst.notificationUrlLocation == "all"
    assert inst.reason == (
    ...
    assert inst.topic == "http://example.org/R4/SubscriptionTopic/admission"
