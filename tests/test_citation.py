...
def impl_citation_1(inst):
    ...
    assert inst.citedArtifact.classification[0].classifier[1].coding[0].version == "5.0.0"
    assert inst.citedArtifact.classification[1].classifier[0].coding[0].code == "EFO_0004327"
    assert inst.citedArtifact.classification[1].classifier[0].coding[0].display == "electrocardiography"
    assert inst.citedArtifact.classification[1].classifier[0].coding[0].system == "http://www.ebi.ac.uk/efo"
    ...
    assert inst.citedArtifact.classification[2].classifier[0].coding[0].code == "FMA_63919"
    assert inst.citedArtifact.classification[2].classifier[0].coding[0].display == "foetus"
    assert inst.citedArtifact.classification[2].classifier[0].coding[0].system == "http://purl.obolibrary.org/obo"
    ...
    assert inst.citedArtifact.classification[9].classifier[0].coding[0].code == "394579002"
    assert inst.citedArtifact.classification[9].classifier[0].coding[0].display == "Cardiology (qualifier value)"
    assert inst.citedArtifact.classification[9].classifier[0].coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.citedArtifact.contributorship.summary[1].source.text == "copied-from-article"
    ...
    assert inst.citedArtifact.publicationForm[0].articleDate == fhirtypes.DateTime.validate("2020-11-12")
    ...
    assert inst.citedArtifact.publicationForm[0].language[0].coding[0].display == "English"
    assert inst.citedArtifact.publicationForm[0].language[0].coding[0].system == "urn:ietf:bcp:47"
    assert inst.citedArtifact.publicationForm[0].language[0].coding[0].version == "4.0.1"
    assert inst.citedArtifact.publicationForm[0].publishedIn.publisher.display == "MIT Laboratory for Computational Physiology"
    ...
    assert inst.citedArtifact.relatesTo[0].document.url == "https://doi.org/10.1038/s41597-021-00811-3"
    ...
    assert inst.citedArtifact.relatesTo[1].document.url == "http://data.bioontology.org/ontologies/EFO"
    ...
    assert inst.citedArtifact.webLocation[4].url == "https://doi.org/10.6084/m9.figshare.13283492"
    ...
    assert inst.summary[1].style.coding[0].system == "http://terminology.hl7.org/ValueSet/citation-summary-style"
...
def test_citation_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "citation-example-research-doi.json"
    )
