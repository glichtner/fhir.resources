...
def impl_immunization_1(inst):
    ...
    assert inst.informationSourceCodeableConcept.coding[0].code == "record"
    assert (
        inst.informationSourceCodeableConcept.coding[0].system
        == "http://terminology.hl7.org/CodeSystem/immunization-origin"
    )
    assert inst.informationSourceCodeableConcept.text == "Written Record"
