...
def impl_measure_2(inst):
    ...
    assert inst.identifier[1].system == "http://hl7.org/fhir/cqi/ecqm/Measure/Identifier/cms"
    assert inst.identifier[1].use == "official"
    assert inst.identifier[1].value == "146"
    assert inst.identifier[2].system == "http://hl7.org/fhir/cqi/ecqm/Measure/Identifier/nqf"
