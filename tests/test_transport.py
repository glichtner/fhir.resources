...
from fhir.resources import transport
...
def impl_transport_1(inst):
    ...
    assert inst.requestedLocation.display == "Requested location for item at City Hospital Lab"
...
def test_transport_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "transport-example.json"
    )
