...
def impl_imagingstudy_1(inst):
    assert inst.basedOn[0].identifier.assigner.reference == "Organization/dicom-organization"
    assert inst.basedOn[0].identifier.type.coding[0].code == "ACSN"
    assert inst.basedOn[0].identifier.type.coding[0].system == "http://terminology.hl7.org/CodeSystem/v2-0203"
    ...
    assert inst.modality[0].coding[0].system == "http://dicom.nema.org/resources/ontology/DCM"
    ...
    assert inst.reason[0].concept.coding[0].display == "Closed fracture of trapezoidal bone of wrist"
    ...
    assert inst.series[0].modality.coding[0].system == "http://dicom.nema.org/resources/ontology/DCM"
