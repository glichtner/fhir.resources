...
from fhir.resources import actordefinition
...
def test_actordefinition_1(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "actordefinition-client.json"
    )
...
def test_actordefinition_2(base_settings):
    ...
    """
    filename = (
        base_settings["unittest_data_dir"] / "actordefinition-server.json"
    )
    inst = actordefinition.ActorDefinition.parse_file(
        filename, content_type="application/json", encoding="utf-8"
    )
