...
def impl_consent_2(inst):
    ...
    assert inst.provision.provision[0].action[1].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].actor[0].reference.reference == "Organization/f001"
...
def impl_consent_3(inst):
    ...
    assert inst.provision.provision[0].actor[0].reference.reference == "Practitioner/f204"
    assert inst.provision.provision[0].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].type == "deny"
    assert inst.provision.type == "permit"
...
def impl_consent_4(inst):
    ...
    assert inst.provision.provision[0].class_fhir[0].system == "http://hl7.org/fhir/fhir-types"
...
def impl_consent_5(inst):
    ...
    assert inst.provision.provision[0].data[0].reference.reference == "MedicationRequest/medrx0305"
    assert inst.provision.provision[0].type == "deny"
    assert inst.provision.type == "permit"
    assert inst.regulatoryBasis[0].coding[0].code == "INFA"
    assert inst.regulatoryBasis[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
...
def impl_consent_6(inst):
    ...
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.provision.provision[0].actor[0].reference.reference == "Organization/f201"
    assert inst.provision.provision[0].actor[0].role.coding[0].code == "CST"
    assert inst.provision.provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[0].actor[0].reference.reference == "Organization/f201"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].code == "CST"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[0].purpose[0].code == "ETREAT"
    assert inst.provision.provision[0].provision[0].purpose[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
...
def impl_consent_7(inst):
    ...
    assert inst.meta.tag[0].display == "test health data"
    assert inst.meta.tag[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    assert inst.provision.provision[0].actor[0].reference.reference == "Practitioner/f001"
    assert inst.provision.provision[0].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].period.end == fhirtypes.DateTime.validate("2019-10-10")
    assert inst.provision.provision[0].period.start == fhirtypes.DateTime.validate("2018-10-10")
    assert inst.provision.provision[0].provision[0].actor[0].reference.reference == "Practitioner/xcda-author"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].code == "AUT"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[0].class_fhir[0].code == "application/hl7-cda+xml"
    assert inst.provision.provision[0].provision[0].class_fhir[0].system == "urn:ietf:bcp:13"
    assert inst.provision.provision[0].provision[0].code[0].coding[0].code == "34133-9"
    assert inst.provision.provision[0].provision[0].code[0].coding[0].system == "http://loinc.org"
    assert inst.provision.provision[0].provision[0].code[1].coding[0].code == "18842-5"
    assert inst.provision.provision[0].provision[0].code[1].coding[0].system == "http://loinc.org"
    assert inst.provision.provision[0].provision[0].type == "permit"
    assert inst.provision.provision[0].type == "deny"
    assert inst.provision.type == "permit"
    assert inst.regulatoryBasis[0].coding[0].code == "INFA"
...
def impl_consent_8(inst):
    ...
    assert inst.provision.provision[0].action[0].coding[0].code == "access"
    assert inst.provision.provision[0].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].actor[0].reference.reference == "Organization/f203"
    assert inst.provision.provision[0].actor[0].role.coding[0].code == "CST"
    assert inst.provision.provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].actor[1].reference.display == "Simone Heps"
    assert inst.provision.provision[0].actor[1].reference.reference == "Practitioner/f007"
    assert inst.provision.provision[0].actor[1].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].actor[1].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].type == "permit"
    assert inst.provision.type == "deny"
...
def impl_consent_10(inst):
    ...
    assert inst.provision.provision[0].provision[0].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[0].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[0].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[0].securityLabel[0].code == "PSY"
    assert inst.provision.provision[0].provision[0].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[0].provision[0].type == "permit"
    assert inst.provision.provision[0].provision[1].action[0].coding[0].code == "access"
    assert inst.provision.provision[0].provision[1].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[1].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[1].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[1].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[1].securityLabel[0].code == "SPI"
    assert inst.provision.provision[0].provision[1].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.provision.provision[0].provision[2].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[2].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[2].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[2].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[2].securityLabel[0].code == "N"
    assert inst.provision.provision[0].provision[2].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    ...
    assert inst.provision.provision[0].provision[3].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[3].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[3].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[3].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[3].securityLabel[0].code == "PSY"
    assert inst.provision.provision[0].provision[3].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.provision.provision[0].provision[4].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[4].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[4].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[4].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[4].securityLabel[0].code == "SPI"
    assert inst.provision.provision[0].provision[4].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.provision.provision[0].provision[5].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[5].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[5].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[5].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[5].securityLabel[0].code == "SEX"
    assert inst.provision.provision[0].provision[5].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.provision.provision[0].provision[6].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[6].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[6].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[6].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[6].securityLabel[0].code == "N"
    assert inst.provision.provision[0].provision[6].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    ...
    assert inst.provision.provision[0].provision[7].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[7].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[7].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[7].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[7].securityLabel[0].code == "PSY"
    assert inst.provision.provision[0].provision[7].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    ...
    assert inst.provision.provision[0].provision[8].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[8].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[8].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[8].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[8].securityLabel[0].code == "SPI"
    assert inst.provision.provision[0].provision[8].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[0].provision[9].action[0].coding[0].code == "access"
    assert inst.provision.provision[0].provision[9].action[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/consentaction"
    assert inst.provision.provision[0].provision[9].actor[0].reference.reference == "Organization/f001"
    assert inst.provision.provision[0].provision[9].actor[0].role.coding[0].code == "PRCP"
    assert inst.provision.provision[0].provision[9].actor[0].role.coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ParticipationType"
    assert inst.provision.provision[0].provision[9].securityLabel[0].code == "SEX"
    assert inst.provision.provision[0].provision[9].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
    assert inst.provision.provision[0].securityLabel[0].code == "N"
    assert inst.provision.provision[0].securityLabel[0].system == "http://terminology.hl7.org/CodeSystem/v3-Confidentiality"
    assert inst.provision.provision[0].type == "permit"
    assert inst.provision.type == "deny"
    assert inst.regulatoryBasis[0].coding[0].code == "INFA"
    assert inst.regulatoryBasis[0].coding[0].system == "http://terminology.hl7.org/CodeSystem/v3-ActCode"
