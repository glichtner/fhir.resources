...
def impl_measurereport_1(inst):
    ...
    assert inst.reporter.reference == "Organization/aa389ad5-e6fe-4030-88ce-010ab96e4ac4"
...
def impl_measurereport_3(inst):
    ...
    assert float(inst.group[0].stratifier[0].stratum[0].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[0].valueCodeableConcept.coding[0].code == "P0Y--P20Y:F"
    assert float(inst.group[0].stratifier[0].stratum[1].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[1].valueCodeableConcept.coding[0].code == "P0Y--P20Y:M"
    assert float(inst.group[0].stratifier[0].stratum[2].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[2].valueCodeableConcept.coding[0].code == "P20Y--P40Y:F"
    assert float(inst.group[0].stratifier[0].stratum[3].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[3].valueCodeableConcept.coding[0].code == "P20Y--P40Y:M"
    assert float(inst.group[0].stratifier[0].stratum[4].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[4].valueCodeableConcept.coding[0].code == "P40Y--P65Y:F"
    assert float(inst.group[0].stratifier[0].stratum[5].measureScoreQuantity.value) == float(1)
    assert inst.group[0].stratifier[0].stratum[5].valueCodeableConcept.coding[0].code == "P40Y--P65Y:M"
...
def impl_measurereport_4(inst):
    ...
    assert inst.group[0].stratifier[0].code.coding[0].code == "AGE_GROUP:SEX"
    assert float(inst.group[0].stratifier[0].stratum[0].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[0].valueCodeableConcept.coding[0].code == "P0Y--P1Y:F"
    assert float(inst.group[0].stratifier[0].stratum[1].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[1].valueCodeableConcept.coding[0].code == "P0Y--P1Y:M"
    assert float(inst.group[0].stratifier[0].stratum[2].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[2].valueCodeableConcept.coding[0].code == "P1Y--P5Y:F"
    assert float(inst.group[0].stratifier[0].stratum[3].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[3].valueCodeableConcept.coding[0].code == "P1Y--P5Y:M"
    assert float(inst.group[0].stratifier[0].stratum[4].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[4].valueCodeableConcept.coding[0].code == "P10Y--P15Y:F"
    assert float(inst.group[0].stratifier[0].stratum[5].measureScoreQuantity.value) == float(0)
    assert inst.group[0].stratifier[0].stratum[5].valueCodeableConcept.coding[0].code == "P10Y--P15Y:M"
    ...
    assert float(inst.group[1].stratifier[0].stratum[0].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[0].valueCodeableConcept.coding[0].code == "P0Y--P1Y:F"
    assert float(inst.group[1].stratifier[0].stratum[1].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[1].valueCodeableConcept.coding[0].code == "P0Y--P1Y:M"
    assert float(inst.group[1].stratifier[0].stratum[2].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[2].valueCodeableConcept.coding[0].code == "P1Y--P5Y:F"
    assert float(inst.group[1].stratifier[0].stratum[3].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[3].valueCodeableConcept.coding[0].code == "P1Y--P5Y:M"
    assert float(inst.group[1].stratifier[0].stratum[4].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[4].valueCodeableConcept.coding[0].code == "P10Y--P15Y:F"
    assert float(inst.group[1].stratifier[0].stratum[5].measureScoreQuantity.value) == float(0)
    assert inst.group[1].stratifier[0].stratum[5].valueCodeableConcept.coding[0].code == "P10Y--P15Y:M"
    ...
    assert inst.group[2].stratifier[0].stratum[0].component[0].valueCodeableConcept.coding[0].code == "P0Y--P1Y"
    assert inst.group[2].stratifier[0].stratum[0].component[1].code.coding[0].code == "SEX"
    assert inst.group[2].stratifier[0].stratum[0].component[1].valueCodeableConcept.coding[0].code == "F"
    assert float(inst.group[2].stratifier[0].stratum[0].measureScoreQuantity.value) == float(0)
    assert inst.group[2].stratifier[0].stratum[1].component[0].code.coding[0].code == "AGE_GROUP"
    assert inst.group[2].stratifier[0].stratum[1].component[0].valueCodeableConcept.coding[0].code == "P0Y--P1Y"
    assert inst.group[2].stratifier[0].stratum[1].component[1].code.coding[0].code == "SEX"
    assert inst.group[2].stratifier[0].stratum[1].component[1].valueCodeableConcept.coding[0].code == "M"
    assert float(inst.group[2].stratifier[0].stratum[1].measureScoreQuantity.value) == float(0)
    assert inst.group[2].stratifier[0].stratum[2].component[0].code.coding[0].code == "AGE_GROUP"
    assert inst.group[2].stratifier[0].stratum[2].component[0].valueCodeableConcept.coding[0].code == "P1Y--P5Y"
    assert inst.group[2].stratifier[0].stratum[2].component[1].code.coding[0].code == "SEX"
    assert inst.group[2].stratifier[0].stratum[2].component[1].valueCodeableConcept.coding[0].code == "F"
    assert float(inst.group[2].stratifier[0].stratum[2].measureScoreQuantity.value) == float(0)
    assert inst.group[2].stratifier[0].stratum[3].component[0].code.coding[0].code == "AGE_GROUP"
    assert inst.group[2].stratifier[0].stratum[3].component[0].valueCodeableConcept.coding[0].code == "P1Y--P5Y"
    assert inst.group[2].stratifier[0].stratum[3].component[1].code.coding[0].code == "SEX"
    assert inst.group[2].stratifier[0].stratum[3].component[1].valueCodeableConcept.coding[0].code == "F"
    assert float(inst.group[2].stratifier[0].stratum[3].measureScoreQuantity.value) == float(0)
