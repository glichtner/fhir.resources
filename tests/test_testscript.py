...
def impl_testscript_1(inst):
    ...
    assert inst.setup.action[0].operation.type.system == "http://hl7.org/fhir/restful-interaction"
    ...
    assert inst.setup.action[2].operation.type.system == "http://hl7.org/fhir/restful-interaction"
    ...
    assert inst.setup.action[4].operation.type.system == "http://hl7.org/fhir/restful-interaction"
    ...
    assert inst.teardown.action[0].operation.type.system == "http://hl7.org/fhir/restful-interaction"
    ...
    assert inst.test[0].action[0].operation.type.system == "http://hl7.org/fhir/restful-interaction"
...
def impl_testscript_2(inst):
    ...
    assert inst.scope[0].conformance.coding[0].system == "http://hl7.org/fhir/testscript-scope-conformance-codes"
    assert inst.scope[0].phase.coding[0].code == "unit"
    assert inst.scope[0].phase.coding[0].system == "http://hl7.org/fhir/testscript-scope-phase-codes"
    assert inst.status == "draft"
    ...
    assert inst.test[1].action[0].operation.type.system == "http://hl7.org/fhir/restful-interaction"
    ...
    assert inst.test[2].action[0].operation.type.system == "http://hl7.org/fhir/restful-interaction"
...
def impl_testscript_4(inst):
    ...
    assert inst.test[0].action[3].operation.type.system == "http://hl7.org/fhir/restful-interaction"
