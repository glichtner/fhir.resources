...
def impl_packagedproductdefinition_1(inst):
    ...
    assert inst.package.package[0].containedItem[0].amountInteger == 10
    assert (
        inst.package.package[0].containedItem[0].item[0].reference.reference
    ...
    assert inst.package.package[0].shelfLifeStorage[0].periodQuantity.unit == "a"
    assert float(
        inst.package.package[0].shelfLifeStorage[0].periodQuantity.value
    ) == float(3)
    assert (
...
def impl_packagedproductdefinition_2(inst):
    ...
    assert inst.package.containedItem[0].amountQuantity.unit == "ml"
    assert float(inst.package.containedItem[0].amountQuantity.value) == float(20)
    assert inst.package.containedItem[0].item[0].reference.reference == "#liquidItem"
    assert inst.package.containedItem[1].item[0].reference.reference == "#syringeDevice"
    assert (
        inst.subject[0].reference
