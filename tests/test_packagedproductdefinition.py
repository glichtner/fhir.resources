...
from fhir.resources import packagedproductdefinition
...
def impl_packagedproductdefinition_2(inst):
    ...
    assert inst.packaging.material[0].coding[0].system == "http://ema.europa.eu/example/packageItemContainerMaterial"
    assert float(inst.packaging.packaging[0].containedItem[0].amount.value) == float(10)
    assert inst.packaging.packaging[0].containedItem[0].item.reference.reference == "ManufacturedItemDefinition/tablet"
    assert inst.packaging.packaging[0].manufacturer[0].reference == "Organization/example"
    assert inst.packaging.packaging[0].material[0].coding[0].code == "PVC"
    assert inst.packaging.packaging[0].material[0].coding[0].system == "http://ema.europa.eu/example/packageItemContainerMaterial"
    assert inst.packaging.packaging[0].material[1].coding[0].code == "PVDC"
    assert inst.packaging.packaging[0].material[1].coding[0].system == "http://ema.europa.eu/example/packageItemContainerMaterial"
    assert inst.packaging.packaging[0].material[2].coding[0].code == "alu"
    assert inst.packaging.packaging[0].material[2].coding[0].system == "http://ema.europa.eu/example/packageItemContainerMaterial"
    ...
    assert inst.packaging.packaging[0].property[0].valueQuantity.system == "http://unitsofmeasure.org"
    assert inst.packaging.packaging[0].property[0].valueQuantity.unit == "mm"
    assert float(inst.packaging.packaging[0].property[0].valueQuantity.value) == float(45)
    ...
    assert inst.packaging.packaging[0].property[1].valueQuantity.system == "http://unitsofmeasure.org"
    assert inst.packaging.packaging[0].property[1].valueQuantity.unit == "mm"
    assert float(inst.packaging.packaging[0].property[1].valueQuantity.value) == float(35)
    assert inst.packaging.packaging[0].quantity == 1
    assert inst.packaging.packaging[0].shelfLifeStorage[0].periodDuration.code == "a"
    assert inst.packaging.packaging[0].shelfLifeStorage[0].periodDuration.system == "http://unitsofmeasure.org"
    assert inst.packaging.packaging[0].shelfLifeStorage[0].periodDuration.unit == "year"
    assert float(inst.packaging.packaging[0].shelfLifeStorage[0].periodDuration.value) == float(3)
    assert inst.packaging.packaging[0].shelfLifeStorage[0].specialPrecautionsForStorage[0].coding[0].code == "none"
    assert inst.packaging.packaging[0].shelfLifeStorage[0].specialPrecautionsForStorage[0].coding[0].system == "http://ema.europa.eu/example/specialprecautionsforstorage"
    assert inst.packaging.packaging[0].shelfLifeStorage[0].type.coding[0].code == "ShelfLifeofPackagedMedicinalProduct"
    assert inst.packaging.packaging[0].shelfLifeStorage[0].type.coding[0].system == "http://ema.europa.eu/example/shelfLifeTypePlaceHolder"
    assert inst.packaging.packaging[0].type.coding[0].code == "Blister"
    assert inst.packaging.packaging[0].type.coding[0].system == "http://ema.europa.eu/example/packageitemcontainertype"
    assert inst.packaging.property[0].type.coding[0].code == "height"
    assert inst.packaging.property[0].valueQuantity.code == "mm"
    assert inst.packaging.property[0].valueQuantity.system == "http://unitsofmeasure.org"
    ...
    assert inst.packaging.property[1].valueQuantity.system == "http://unitsofmeasure.org"
    ...
    assert inst.packaging.property[2].valueQuantity.system == "http://unitsofmeasure.org"
    ...
    assert inst.packaging.type.coding[0].system == "http://ema.europa.eu/example/packageitemcontainertype"
    assert inst.text.status == "generated"
