...
def impl_contract_2(inst):
    ...
    assert inst.term[0].asset[0].type[0].coding[0].code == "urn:uuid:3a48c68c-318d-4c68-8471-4a3c10fcb41b"
...
def impl_contract_4(inst):
    ...
    assert inst.term[0].group[0].subType.coding[0].system == "http://hl7.org/fhir/fhir-types"
    ...
    assert inst.term[0].group[1].subType.coding[0].system == "http://hl7.org/fhir/fhir-types"
