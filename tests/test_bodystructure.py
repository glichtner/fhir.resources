...
def impl_bodystructure_1(inst):
    ...
    assert inst.includedStructure[0].laterality.coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.includedStructure[0].qualifier[0].coding[0].system == "http://snomed.info/sct"
    ...
    assert inst.includedStructure[0].structure.coding[0].system == "http://snomed.info/sct"
...
def impl_bodystructure_3(inst):
    ...
    assert inst.includedStructure[0].structure.coding[0].display == "Entire fetus (body structure)"
    assert inst.includedStructure[0].structure.coding[0].system == "http://snomed.info/sct"
