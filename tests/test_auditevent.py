...
def impl_auditevent_2(inst):
    ...
    assert inst.entity[1].name == "data about Everthing important"
    ...
    assert inst.outcome.text == "Successful Disclosure"
...
def impl_auditevent_4(inst):
    ...
    assert inst.outcome.text == "Successful  Start of Break-Glass"
    assert inst.purposeOfEvent[0].coding[0].code == "ETREAT"
    assert inst.purposeOfEvent[0].coding[0].display == "Emergency Treatment"
    assert (
        inst.purposeOfEvent[0].coding[0].system
        == "http://terminology.hl7.org/CodeSystem/v3-ActReason"
    )
    ...
    assert inst.subtype[0].code == "110127"
    assert inst.subtype[0].display == "Emergency Override Started"
    assert inst.subtype[0].system == "http://dicom.nema.org/resources/ontology/DCM"
    assert inst.text.status == "generated"
    assert inst.type.code == "110113"
    assert inst.type.display == "Security Alert"
    assert inst.type.system == "http://dicom.nema.org/resources/ontology/DCM"
...
def impl_auditevent_6(inst):
    ...
    assert inst.entity[1].name == "transaction failed"
    ...
    assert inst.outcome.coding[0].code == "8"
    assert inst.outcome.coding[0].display == "Serious Failure"
    assert (
        inst.outcome.coding[0].system
        == "http://terminology.hl7.org/CodeSystem/audit-event-outcome"
    )
    assert inst.outcome.text == (
