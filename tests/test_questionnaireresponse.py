...
def impl_questionnaireresponse_2(inst):
    ...
    assert inst.item[0].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/itemWeight"
    ...
    assert inst.item[1].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/itemWeight"
    ...
    assert inst.item[2].answer[0].valueCoding.extension[0].url == "http://hl7.org/fhir/StructureDefinition/itemWeight"
...
def impl_questionnaireresponse_3(inst):
    ...
    assert inst.id == "3141"
    assert inst.identifier[0].system == "http://example.org/fhir/NamingSystem/questionnaire-ids"
...
def impl_questionnaireresponse_5(inst):
    ...
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[0].answer[0].valueDateTime == fhirtypes.DateTime.validate("1972-11-30")
    ...
    assert inst.item[0].item[1].item[2].answer[0].item[0].item[1].answer[0].valueDateTime == fhirtypes.DateTime.validate("1972-12-11")
