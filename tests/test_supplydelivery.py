...
def impl_supplydelivery_2(inst):
    ...
    assert inst.type.coding[0].system == "http://hl7.org/fhir/supplydelivery-supplyitemtype"
...
def impl_supplydelivery_4(inst):
    ...
    assert inst.suppliedItem[0].itemCodeableConcept.coding[0].display == "Blood collect tubes blue cap"
