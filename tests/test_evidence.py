...
def impl_evidence_1(inst):
    ...
    assert inst.url == "Evidence/example-stroke-no-alteplase-fatalICH"
    assert (
...
def impl_evidence_2(inst):
    ...
    assert inst.url == "Evidence/example-ASTRAL-12-alteplase-mRS3-6"
...
def impl_evidence_3(inst):
    ...
    assert inst.url == "Evidence/example-stroke-0-3-alteplase-vs-no-alteplase-mRS3-6"
...
def impl_evidence_4(inst):
    ...
    assert inst.url == (
        "Evidence/example-stroke-3-4half-alteplase-vs-no-alteplase-" "mRS0-2"
    )
...
def impl_evidence_5(inst):
    ...
    assert inst.url == "Evidence/example-stroke-alteplase-fatalICH"
    assert (
        inst.variableDefinition[0].intended.display
        == "adults with acute ischemic stroke"
    )
