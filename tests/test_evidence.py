...
def impl_evidence_3(inst):
    ...
    assert inst.certainty[0].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[0].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[0].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[1].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[1].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[2].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[2].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[3].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[3].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    ...
    assert inst.certainty[0].subcomponent[4].rating.coding[0].system == "http://hl7.org/fhir/certainty-rating"
    ...
    assert inst.certainty[0].subcomponent[4].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    assert inst.certainty[0].type.coding[0].code == "Overall"
    assert inst.certainty[0].type.coding[0].display == "Overall quality"
    assert inst.certainty[0].type.coding[0].system == "http://hl7.org/fhir/certainty-type"
    assert inst.description == (
    ...
    assert inst.name == (
    "EffectOfAlteplaseVsNoAlteplaseOnMRS36At90DaysInStroke03Hours"
    "Prior"
    )
...
def impl_evidence_4(inst):
    ...
    assert inst.name == (
    "EffectOfAlteplaseVsNoAlteplaseOnMRS02At90DaysInStroke345Hour"
    "sPrior"
    )
    assert inst.relatedArtifact[0].display == "Figure 2 Lees 2016"
    assert inst.relatedArtifact[0].document.url == "https://doi.org/10.1161/STROKEAHA.116.013644"
...
def impl_evidence_5(inst):
    ...
    assert inst.relatedArtifact[0].document.url == "https://doi.org/10.1161/STROKEAHA.116.012802"
